...
    sᴛᴀᴛᴜs ᴜsᴇʀ : ᴍᴇᴍʙᴇʀ ᴏғ sɪ ʀᴀxxʏ
</blockquote>
"""
        else:
...
{bot.me.mention}
    ...
    ᴘʀᴇғɪxᴇs : {' '.join(prefix)}
    sᴛᴀᴛᴜs ᴜsᴇʀ : ɴᴏᴛ ᴀ ᴍᴇᴍʙᴇʀ ᴏғ sɪ ʀᴀxxʏ   
</blockquote>        
"""
        return text
...
<b>💳 ᴍᴏᴛᴏᴅᴇ ᴘᴇᴍʙᴀʏᴀʀᴀɴ:</b>
 <b>├ ᴅᴀɴᴀ​</b>
 <b>├────• <code>0895640083787</code></b>
 <b>├ ᴀɴ Dean</b>​
 <b>├────• ᴜɴᴛᴜᴋ ᴍᴇᴛᴏᴅᴇ ᴘᴇᴍʙᴀʏᴀʀᴀɴ ʟᴀɪɴɴʏᴀ ʙɪꜱᴀ ʟᴀɴɢꜱᴜɴɢ ʜᴜʙ @whoisraxxy
...
• sᴜᴘᴘᴏʀᴛ @Vinacantik23 ᴅɪ ᴛᴇʟᴇɢʀᴀᴍ

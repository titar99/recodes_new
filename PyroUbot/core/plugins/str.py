...
async def ping_cmd(client, message):
    ...
    if client.me.is_premium:
        _ping = f"""
<blockquote><b>{pong1} <b>ᴘᴏɴɢ</b> — {int(delta_ping)} <u>ms</u>
<b>{pong2} <b>ᴜʙᴏᴛ</b> — <code>{bot.me.mention}</code>
<b>{pong3} <b>ᴏᴡɴᴇʀ</b> — <a href=tg://user?id={client.me.id}>{client.me.first_name} {client.me.last_name or ''}</a></blockquote>
"""
    else:
        _ping = f"""
<blockquote><b>❏ ᴘᴏɴɢ</b> — {int(delta_ping)} <u>ms</u></code>
<b>├ ᴜʙᴏᴛ</b> — <code>{bot.me.mention}</code>
<b>╰ ᴏᴡɴᴇʀ</b> — <a href=tg://user?id={client.me.id}>{client.me.first_name} {client.me.last_name or ''}</a></blockquote>
"""

...
__HELP__ = """
<blockquote>
 <b>ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴀɴɪᴍᴀꜱɪ</b>

• <b>ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}kntl ᴏʀ {0}penis</code> 
• <b>ᴘᴇɴᴊᴇʟᴀꜱᴀɴ:</b> <i>ᴄᴏʙᴀ ꜱᴇɴᴅɪʀɪ.</i>  

• <b>ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}ajg ᴏʀ {0}babi</code> 
• <b>ᴘᴇɴᴊᴇʟᴀꜱᴀɴ:</b> <i>ᴄᴏʙᴀ ꜱᴇɴᴅɪʀɪ.</i>

• <b>ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}nah ᴏʀ {0}y</code> 
• <b>ᴘᴇɴᴊᴇʟᴀꜱᴀɴ:</b> <i>ᴄᴏʙᴀ ꜱᴇɴᴅɪʀɪ.</i>

• <b>ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}ange ᴏʀ {0}lipkol</code> 
• <b>ᴘᴇɴᴊᴇʟᴀꜱᴀɴ:</b> <i>ᴄᴏʙᴀ ꜱᴇɴᴅɪʀɪ.</i>  

• <b>ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}nakal ᴏʀ {0}piss</code> 
• <b>ᴘᴇɴᴊᴇʟᴀꜱᴀɴ:</b> <i>ᴄᴏʙᴀ ꜱᴇɴᴅɪʀɪ.</i>  

• <b>ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}kocok</code> 
• <b>ᴘᴇɴᴊᴇʟᴀꜱᴀɴ:</b> <i>ᴄᴏʙᴀ ꜱᴇɴᴅɪʀɪ.</i>
</blockquote>
"""

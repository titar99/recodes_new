...
__MODULE__ = "animasi2"
__HELP__ = """
<blockqoute><b>『 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴀɴɪᴍᴀꜱɪ II 』</b></blockqoute>

  <blockqoute><b>• cmd:</b> <code>{0}dino</code> 
  <b>➠ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴀɴɪᴍᴀꜱɪ ᴅɪɴᴏ

  <b>• cmd:</b> <code>{0}hack</code> 
  <b>➠ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴀɴɪᴍᴀꜱɪ ʜᴀᴄᴋ ᴡʜᴀᴛꜱᴀᴘᴘ.

  <b>• cmd:</b> <code>{0}gabut</code> 
  <b>➠ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴀɴɪᴍᴀꜱɪ ɢᴀʙᴜᴛ.

  <b>• cmd:</b> <code>{0}loveyou</code> 
  <b>➠ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴀɴɪᴍᴀꜱɪ ʟᴏᴠᴇ.

  <b>• cmd:</b> <code>{0}bomb</code> 
  <b>➠ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴀɴɪᴍᴀꜱɪ ʙᴏᴍʙ.

  <b>• cmd:</b> <code>{0}charge</code> 
  <b>➠ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴀɴɪᴍᴀꜱɪ ᴄʜᴀʀɢᴇ ʜᴘ.</blockqoute>
"""
